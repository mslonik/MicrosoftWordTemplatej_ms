...
Public Const C_M_Content = "Content"
...
Public Const C_SC_CtrlB As String = "Ctrl + B"                  ' Bold in Tools
Public Const C_SC_CtrlI As String = "Ctrl + I"                  ' Italic in Tools
Public Const C_SC_CtrlP As String = "Ctrl + P"                  ' CustomizedPrinting
Public Const C_SC_CtrlU As String = "Ctrl + U"                  ' Underline in Tools
Public Const C_SC_CtrlS As String = "Ctrl + S"                  ' CustomizedFileSave
...
Public Const C_SC_ShiftCtrlX As String = "Shift + Ctrl + X"     ' Strikethrough in Tools
Public Const C_SC_ShiftCtrlH As String = "Shift + Ctrl + H"     ' ToggleCharHiddenStyle in Styles
Public Const C_SC_ShiftCtrlK As String = "Shift + Ctrl + K"     ' ToggleCharSourceCode in Styles
